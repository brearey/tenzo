...
uint8_t DOUT_PIN = A0;                                                                     // указываем вывод DOUT, к которому подключен HX711
uint8_t SCK_PIN  = A1;                                                                     // указываем вывод SCK , к которому подключен HX711

float     weight_of_standard = 100;                                                     // указываем эталонный вес в унциях
